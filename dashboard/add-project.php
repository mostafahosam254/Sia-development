                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input type="text" class="form-control" id="userName3" name="title" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mb-3">
                                                                        <label class="col-md-3 col-form-label" for="userName3">Category</label>
                                                                        <div class="col-md-9">
                                                                            <input type="text" class="form-control" id="userName3" name="category" >
                                                                        </div>
                                                                    </div>
...
if (isset($_POST['add-main-services-data'])) {
    ...
    $ins = $conn->prepare("INSERT INTO portfolio (`title` , `category`,`file_Name` , `file_Type` , `file`  )
    VALUES( :title , :category ,  :file_Name , :file_Type , :file)");
    
    $ins->bindParam("title",$title);//(value,$variable) confirm
    ...
    // $ins->execute();
    if ($ins->execute()) {
        echo '<script>window.alert("New project is Publushed Now!")</script>';
    }else {
